...
for x in range(0, W, 40):
    draw.line([(x, 0), (x, H)], fill=(31, 41, 55))
for y in range(0, H, 40):
    draw.line([(0, y), (W, y)], fill=(31, 41, 55))
...
for x in range(W):
    t = x / (W - 1)
    c = (
        int(cyan[0] * (1 - t) + blue[0] * t),
        int(cyan[1] * (1 - t) + blue[1] * t),
        int(cyan[2] * (1 - t) + blue[2] * t),
    )
...
center_text("Muhammad Ammar Shaikh", name_font, 100, (248, 250, 252))
center_text("AI / ML Engineer  |  Full-Stack Developer", role_font, 185, (34, 211, 238))
center_text("Building production AI systems", sub_font, 230, (156, 163, 175))
